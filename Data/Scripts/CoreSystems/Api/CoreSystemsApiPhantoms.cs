...
namespace CoreSystems.Api
{
    ...
    public partial class WcApi 
    {
        ...
        private Action<MyEntity, TriggerActions> _setTriggerState;
        ...
        private Func<string, uint, bool, long, string, TriggerActions, float?, MyEntity, bool, bool, MyEntity> _spawnPhantom;
        ...
        internal void SetTriggerState(MyEntity phantom, TriggerActions trigger) => _setTriggerState?.Invoke(phantom, trigger);
        ...
        /// <returns></returns>
        internal MyEntity SpanwPhantom(string phantomType, uint maxAge = 0, bool closeWhenOutOfAmmo = false, long defaultReloads = long.MaxValue, string ammoOverideName = null, TriggerActions trigger = TriggerActions.TriggerOff, float? modelScale = null, MyEntity parnet = null, bool addToPrunning = false, bool shadows = false)
            => _spawnPhantom?.Invoke(phantomType, maxAge, closeWhenOutOfAmmo, defaultReloads, ammoOverideName, trigger, modelScale, parnet, addToPrunning, shadows) ?? null;
    }
}