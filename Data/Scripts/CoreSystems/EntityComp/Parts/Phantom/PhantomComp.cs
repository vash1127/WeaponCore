...
namespace CoreSystems.Platform
{
    public partial class Phantom 
    {
        ...
        {
            internal readonly PhantomCompData Data;
            internal readonly PhantomStructure Structure;
            ...
            internal PhantomComponent(Session session, MyEntity coreEntity, MyDefinitionId id)
            {
                ...
                Init(session, coreEntity, false, Data, coreEntity, id);
                Structure = (PhantomStructure)Platform.Structure;
            }
