...
namespace WeaponCore.Platform
{
    public partial class Part
    {
        ...
        public void StopTriggerAv(bool power)
        {
            if (System.Values.HardPoint.Audio.FireSoundEndDelay > 0)
                Comp.Session.FutureEvents.Schedule(StopTriggerSound, null, System.Values.HardPoint.Audio.FireSoundEndDelay);
            else StopTriggerSound(false);

            StopPreTriggerSound();
            if (AvCapable && RotateEmitter != null && RotateEmitter.IsPlaying) StopRotateSound();
            if (!power) StopRotateSound();
            
            StopDummyAvTick = Comp.Session.Tick;
        ...
        public void StopPreTriggerSound()
        {
            if (PreFiringEmitter == null)
                return;
        ...
        public void StopTriggerSound(object o = null)
        {
            if (FiringEmitter == null)
                return;
