    ...
    public partial class Projectiles
    {
        ...
        private void GenProjectiles()
        {
            for (int i = 0; i < NewProjectiles.Count; i++) {
                ...
                p.Info.MaxTrajectory = t != Kind.Client ? a.Const.MaxTrajectoryGrows && firingCounter < a.Trajectory.MaxTrajectoryTime ? a.Const.TrajectoryStep * firingCounter : a.Const.MaxTrajectory: gen.MaxTrajectory;
