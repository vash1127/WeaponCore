...
namespace WeaponCore
{
    ...
    public class ProtoPhantomRepo : ProtoRepo
    {
        ...
        public void ResetToFreshLoadState()
        {
            ...
            for (int i = 0; i < Values.State.Phantoms.Length; i++)
            {
                var ws = Values.State.Phantoms[i];
                ws.Heat = 0;
                ws.Overheated = false;
    ...
    [ProtoContract]
    public class ProtoPhantomSettings
    {
        ...
        [ProtoMember(6)] public ProtoPhantomOverrides Overrides;


        public ProtoPhantomSettings()
        {
    ...
    [ProtoContract]
    public class ProtoPhantomState
    {
        public enum Caller
        {
            Direct,
        ...
        [ProtoMember(1)] public uint Revision;
        [ProtoMember(2)] public ProtoPhantomPartState[] Phantoms;
    ...
    [ProtoContract]
    public class ProtoPhantomPartState
    {
        ...
        public void Sync(ProtoPhantomPartState sync)
        {
            Heat = sync.Heat;
    ...
    [ProtoContract]
    public class ProtoPhantomOverrides
    {
        ...
        public ProtoPhantomOverrides() { }

        public void Sync(ProtoPhantomOverrides syncFrom)
        {
