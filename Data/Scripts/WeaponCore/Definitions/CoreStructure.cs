...
using static WeaponCore.Support.PartDefinition.AmmoDef.ShapeDef.Shapes;
namespace WeaponCore.Support
{
    ...
    public class AmmoConstants
    {
        ...
        private MyConcurrentPool<MyEntity> Models(AmmoDef ammoDef, PartDefinition wDef, out bool primeModel, out bool triggerModel, out string primeModelPath)
        {
