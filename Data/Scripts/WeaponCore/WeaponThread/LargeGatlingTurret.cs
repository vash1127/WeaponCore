    ...
    partial class Weapons
    {
        WeaponDefinition LargeGatlingTurret => new WeaponDefinition
        {
            Assignments = new ModelAssignments
            {
                MountPoints = new[]
                {
                    MountPoint(subTypeId: "LargeGatlingTurret", aimPartId:"GatlingBarrel", muzzlePartId: "GatlingBarrel", azimuthPartId: "CoreTurret", elevationPartId:"MissileTurretBarrels"),
                },
            ...
            HardPoint = new HardPointDefinition
            {
                ...
                Block = AimControl(trackTargets: true, turretAttached: true, turretController: true, rotateRate: 0.02f, elevateRate: 0.02f, minAzimuth: 0, maxAzimuth: 0, minElevation: 0, maxElevation: 0, offset: Vector(x: 0, y: 0, z: 0), fixedOffset: false, debug: false),
