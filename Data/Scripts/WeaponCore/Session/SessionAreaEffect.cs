    ...
    public partial class Session
    {
        ...
        private void UpdateField(HitEntity hitEnt, ProInfo info)
        {
            ...
            if (info.AmmoDef.Const.AreaEffect == PullField || info.AmmoDef.Const.AreaEffect == PushField)
            {
                ...
                grid.Physics.AddForce(MyPhysicsForceType.APPLY_WORLD_IMPULSE_AND_WORLD_ANGULAR_IMPULSE, dir * info.AmmoDef.Mass, grid.Physics?.CenterOfMassWorld, Vector3.Zero);
            }
            else
            {
