...
namespace WeaponCore
{
    internal static class WepUi
    {
        ...
        {
            var comp = block?.Components?.Get<WeaponComponent>();
            if (comp?.Platform == null || comp.Platform == null || comp.Platform.State != MyWeaponPlatform.PlatformState.Ready) return;
        ...
        {
            var comp = block?.Components?.Get<WeaponComponent>();
            if (comp?.Platform == null || comp.Platform == null || comp.Platform.State != MyWeaponPlatform.PlatformState.Ready) return 0;
        ...
        internal static float GetRange(IMyTerminalBlock block) {
            var comp = block?.Components?.Get<WeaponComponent>();
            if (comp?.Platform == null || comp.Platform == null || comp.Platform.State != MyWeaponPlatform.PlatformState.Ready) return 100;
