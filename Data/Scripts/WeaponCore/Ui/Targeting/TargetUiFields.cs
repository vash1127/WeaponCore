...
namespace WeaponCore
{
    internal partial class TargetUi
    {
        ...
        private readonly Dictionary<string, IconInfo[]> _targetIcons = new Dictionary<string, IconInfo[]>()
        {
            ...
            {"distance", new[] {
                new IconInfo(MyStringId.GetOrCompute("DS_TargetDistanceNear"), 0.05, new Vector2D(-0.10, 1f), 1, true),
                new IconInfo(MyStringId.GetOrCompute("DS_TargetDistanceNearMid"), 0.05, new Vector2D(-0.10, 1f), 1, true),
                new IconInfo(MyStringId.GetOrCompute("DS_TargetDistanceFarMid"), 0.05, new Vector2D(-0.10, 1f), 1, true),
                new IconInfo(MyStringId.GetOrCompute("DS_TargetDistanceFar"), 0.05, new Vector2D(-0.10, 1f), 1, true),
            }},
            {"speed", new[] {
